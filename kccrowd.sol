...
contract KaseiCoinCrowdsale is Crowdsale, MintedCrowdsale { // UPDATE THE CONTRACT SIGNATURE TO ADD INHERITANCE
    ...
    constructor(
       ...
       // that will be used in the constructor        
        ...
        ) public Crowdsale (exchange_rate, wallet_for_proceeds, KaseiCoin_contract_addr) {
...
contract KaseiCoinCrowdsaleDeployer {
    ...
    constructor(  
       ...
       address payable wallet
        ...
        KaseiCoinCrowdsale crowdsale_contract = new KaseiCoinCrowdsale (exchange_rate, wallet, token_contract);            
